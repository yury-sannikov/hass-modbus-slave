...
from custom_components.modbus_slave.bit_switch import setup_bit_swithes
from custom_components.modbus_slave.const import (
    CONF_BIT_SWITCHES,
...
@mock.patch("custom_components.modbus_slave.bit_switch._LOGGER")
...
async def test_register_switch_last_state(
    mock_read, hass_storage, hass, read_data, last_state, init_expected, expected
):
    """Run test for given config."""
